...
public class DataDAO {
    public static List<Data> getAllFiles(String email) throws SQLException { //to show the file data
    ...
    public static void unhide(int id) throws SQLException, IOException {
        ...
        fw.close();
        ps = connection.prepareStatement("delete from data where id = ?"); //when file is unhidden the delete that entries from db
        ps.setInt(1, id);
        ps.executeUpdate();
